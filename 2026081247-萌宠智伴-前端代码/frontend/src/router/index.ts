...
const routes = [
  ...
  },
  {
    ...
    children: [
      ...
      { path: 'ai-board', name: 'TeacherAIBoard', meta: { title: 'AI 学习看板', icon: 'DataAnalysis' }, component: () => import('../views/teacher/AIBoard.vue') },
      { path: 'ai-chat-monitor', name: 'TeacherAIChatMonitor', meta: { title: '对话查看与关注', icon: 'ChatLineRound' }, component: () => import('../views/teacher/AIChatMonitor.vue') },
      { path: 'ai-course-content', name: 'TeacherAICourseContent', meta: { title: 'AI 课程内容', icon: 'Notebook' }, component: () => import('../views/teacher/AICourseContent.vue') },
      { path: 'ai-book-assets', name: 'TeacherAIBookAssets', meta: { title: '照片绘本素材', icon: 'PictureFilled' }, component: () => import('../views/teacher/AIBookAssets.vue') },
    ],
  },
  {
    path: '/admin',
    ...
    children: [
      ...
      { path: 'ai-courses', name: 'AdminAICourses', meta: { title: 'AI 课程库', icon: 'Collection' }, component: () => import('../views/admin/AICourseLibrary.vue') },
      { path: 'ai-overview', name: 'AdminAIOverview', meta: { title: 'AI 使用总览', icon: 'TrendCharts' }, component: () => import('../views/admin/AIOverview.vue') },
      { path: 'ai-reviews', name: 'AdminAIReviews', meta: { title: 'AI 内容审核', icon: 'Checked' }, component: () => import('../views/admin/AIReview.vue') },
    ],
  },
